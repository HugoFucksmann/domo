...
export const finalMsjGlosario = {
	...
	incorrecto:
		'Las palabras que usamos cotidianamente para designar distintas prácticas, identidades y orientaciones sexuales, muchas veces están apoyadas en mitos y prejuicios. Te invitamos a descargar este glosario para que puedas informarte y compartirlo con quienes desees:',
};
...
export const dataGlosario = [
	{
		...
		afirmacion: [
			...
			{
				frace:
					'“Si sos lesbiana es porque no encontraste al hombre indicado”',
				acuerdo: {
					title: 'Lesbiana',
	...
	},
	{
		...
		afirmacion: [
			...
			{
				frace:
					'“Los niños de parejas gays, también serán homosexuales”',
				acuerdo: {
					title: 'Gay',
